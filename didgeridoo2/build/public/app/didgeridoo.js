...
define("jqueryTmpl", ["jquery"], function(){});
...
define('actions',['require'], function(require) {
...
define("codemirror_script",[], function(){});
...
define('didgeridoo',[
    ...
    require(['modules/ui/layout/layout'], function(layout) {
        ...
        /*require(['modules/ui/dom-inspector/main'], function(DOMInspector) {
        ...
        require(['modules/ui/document/HTMLDocument'], function(HTMLDocument) {
            ...
            doc1.load('/p/5196534c9c253bdbb1d00fb6/f/index.html', 'text/html');
        });
    });
