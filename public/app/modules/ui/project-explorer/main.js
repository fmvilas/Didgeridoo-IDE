    ...
    var ProjectExplorer = function() {
        ...
        var _render = function(selector) {
            ...
            $('#didgeridoo-project-explorer-tree-wrapper').dynatree({
                initAjax: {
                    url: '/project/' + didgeridoo.currentProject + '/files'
                },
                onPostInit: function() {
                    this.getNodeByKey('/'+didgeridoo.currentProject+'/').sortChildren(_compareFunction, true);
                },
                onLazyRead: function(node){
                    node.appendAjax({
                        ...
                        success: function() {
                            node.tree.getNodeByKey('/'+didgeridoo.currentProject+'/').sortChildren(_compareFunction, true);
                        }
                    });
                },
                fx: {
