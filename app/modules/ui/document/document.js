...
define(function() {
    ...
    var _init = function(module) {
        ...
        if( typeof didgeridoo.documents === 'undefined' ) {
            didgeridoo.documents = {};        
    }
...
var Document = function() {
    ...
    var _load = function(url, callback) {
        ...
        $.tmpl( documentTemplate, {
            ...
            url: _url,
            title: _title
        } ).appendTo( didgeridoo.modules.get('ui/layout').getCenterPanel() );
        $(didgeridoo.modules.get('ui/layout').getCenterPanel()).tabs( 'add', '#' + _id, _title );
			
        didgeridoo.modules.load('ui/designer', function(Designer) {
            _designer = new Designer(_id);
				
            $(didgeridoo.modules.get('ui/layout').getCenterPanel()).tabs( 'select', '#' + _id );
            ...
            didgeridoo.modules.get('ui/layout').getSideBar().addPanel('ui/tools');
        });
