...
window.didgeridoo = (function () {
    ...
    var _components = (function() {
        ...
        var _register = function(id, deps, component) {
            console.log('TODO: register component ' + id);
        };
        
        var _load = function(id, callback) {
            didgeridoo.utils.assert(
                typeof id === 'string' &&
                id.trim().length > 0,
                'Error intentando cargar componente. El id no es valido.'
            );
            
            didgeridoo.utils.assert(
                typeof callback === 'undefined' ||
                typeof callback === 'function',
                'Error intentando cargar componente. El callback no es valido.'
            );
