...
YUI.add('yui', function(Y){}, '3.6.0pr2' ,{use:['yui-base','get','features','intl-base','yui-log','yui-later']});
...
}, '3.6.0pr2' ,{use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','querystring-stringify-simple']});
var Y = YUI().use('*');
